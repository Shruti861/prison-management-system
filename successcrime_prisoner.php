        ...
        <div class="container px-4 sm:px-8 lg:px-16 xl:px-20 mx-auto">
            ...
            <div class="hero-wrapper grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
                ...
                <div class="hero-text col-span-6">
                    ...
                    <p class="text-gray-800 text-base leading-relaxed mt-8 font-semibold">Prisoner & Crime Details added successfully!</p>
                    <p class="text-gray-800 text-base leading-relaxed mt-8 font-semibold">Click <a href="./crime.php" class="text-green-600">here</a> to add another</p>
